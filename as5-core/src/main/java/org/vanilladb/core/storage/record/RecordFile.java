...
public class RecordFile implements Record {
	...
	public void setVal(String fldName, Constant val) {
		// System.out.println("Start Record File setShadowVal ...");
		...
		// setVal to the record Page ...
		// SX - Write the temp data to the tx.workspace
		// tx.processWorkspace(this.rp, fldName, v);
		rp.setVal(fldName, v);
		// rp.setVal(fldName, v);
		// System.out.println("End Record File setShadowVal ...");
	}
