...
//		System.out.println("Start File Initing ...");
		ServerInit.init(FileTest.class);
//		System.out.println("Start File Initing class ...");
		fm = VanillaDb.fileMgr();
		p1 = new Page();
		p2 = new Page();
		p3 = new Page();
//		System.out.println("Start File Initing page ...");
		if (logger.isLoggable(Level.INFO))
			logger.info("BEGIN FILE TEST");
//		System.out.println("End File Initing ...");
	}
...
//		System.out.println("Start testReadWriteAppend ...");
		...
		assertTrue("*****FileTest: bad read",
				p2.getVal(0, INTEGER).equals(TEST_INT_123)
						&& p2.getVal(INT_SIZE, INTEGER).equals(TEST_INT_456));
//		System.out.println("End testReadWriteAppend ...");
	}
