...
//		System.out.println("tx Num : " + rp.getTx().getTransactionNumber());
...
//			System.out.println("hi : ==");
		...
		rp.close();
//		System.out.println("numinserted : " + numinserted / 3);
//		System.out.println("numdeleted : " + numdeleted );
	...
	public void testRecordFile() {
		...
		rf.beforeFirst();
		while (rf.next()) {
//			System.out.println("Long Val: " + (Long)30L + " " + (Long) rf.getVal("deptid").asJavaVal());
